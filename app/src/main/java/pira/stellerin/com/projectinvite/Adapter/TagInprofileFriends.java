...
/**
 * Created by Pira on 11/09/2015.
 */
public class TagInprofileFriends extends ArrayAdapter<ParseObject> {
        Context context;
        int layoutResourceId;
        List<ParseObject> tag=null;


public TagInprofileFriends(Context context,int layoutResourceId,
