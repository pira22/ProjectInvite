 ...
 */
public class GetPicAdapter extends ArrayAdapter<Uri> {

    Context context;
    int layoutResourceId;
    List<Uri> url = null;

    public GetPicAdapter(Context context, int layoutResourceId,
                                List<Uri> url) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            Picasso.with(context).load(urlfile).resize(300, 300).into(holder.image);
