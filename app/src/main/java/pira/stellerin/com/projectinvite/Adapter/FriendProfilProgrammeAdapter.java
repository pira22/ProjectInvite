...
/**
 * Created by Pira on 10/09/2015.
 */
public class FriendProfilProgrammeAdapter extends ArrayAdapter<Programme> {

    Context context;
    int layoutResourceId;
    List<Programme> programme = null;
    Boolean visible;
    public FriendProfilProgrammeAdapter(Context context, int layoutResourceId,
